...
from pegasus.simulator.logic.graphical_sensors.fisheye_camera import FisheyeCamera
...
class PegasusApp:
    ...
    def __init__(self):
        ...
        mavlink_config = PX4MavlinkBackendConfig({
            "vehicle_id": 0,
            "px4_autolaunch": True,
            "px4_dir": "/home/henryshum0/PX4-Autopilot"
        })
        ...
        config_multirotor.graphical_sensors = [FisheyeCamera("camera", config={"update_rate": 30.0})]
